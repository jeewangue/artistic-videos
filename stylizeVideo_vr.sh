...
if [ "$backend" == "cudnn" ]; then
  ...
  in the format w:h, or leave blank to use the original resolution [320:180] $cr > " resolution
...
echo ""
read -p "How much do you want to weight the spatial term? \
Default value: 1e3 for a resolution of 450x350. Increase for a higher resolution. \
[1e3] $cr > " spatial_weight
spatial_weight=${spatial_weight:-1e3}
